...
namespace ControleMedicamentos.ConsoleApp.Compartilhado
{
    public class TelaMenuPrincipal
    {
        ...
        public TelaMenuPrincipal(Notificador notificador)
        {
            ...
            telaCadastroRequisicao = new TelaCadastroRequisicao( telaCadastroMedicamento,  telaCadastroPaciente,  repositorioRequisicao,  repositorioMedicamento,
             repositorioPaciente,  notificador);
        }
